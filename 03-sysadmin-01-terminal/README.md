...
Вернётся 0   
проверка с помощью конструкции echo $? (данная конструкция выводит логическое значение результата предыдущей команды. 0 - если успешное выполнение, 1 - если ошибка)    
[[ -d /tmp ]] ; echo $?     
