...
Управлять инфраструктурой как кодом, контроллируя историю изменения версий для удобства нахождения ошибок, т.к за каждой ошибкой стоит конкретная фамилия )).
