...
```doc
Высоконагруженная база данных, чувствительная к отказу. --> Высокодоступный кластер из физическиих серверов. 
...
при этом не тратить ресурсы на эмуляцию флоппи дисковода (nginx отлично работает и без него),
