...
### Решение
На мой взгляд для всех этих сервисов, кроме мобильных приложений, отлично подойдёт платформа Docker (установленная на физическом сервере) c её микро сервисной архитектурой. Контейнеры Docker взаимодействуют напрямую с ядром OS. Это обеспечит максималбную производительность всем приложениям. Для тестирования мобильных приложений в зависимости от требований ПО я бы воспользовался физической машиной или одной из платформ виртуализации.
